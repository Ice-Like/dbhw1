    ...
    <main>
      ...
      <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li class="mb-1">
          <button style="color:red;" class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#inside-collapse" aria-expanded="false">
            內部人員管理
          </button>
          '
          .(
            ($select=='employee' or $select=='person' or $select=='exp' or $select=='overtime' or $select=='leav' or $select=='dept' or $select=='quota') ?
            '<div class="collapse show" id="inside-collapse">'
            :
            '<div class="collapse" id="inside-collapse">'
          ).
          '
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
              ...
              .(
                ($select=='employee') ?
                '<li><a href="employee.php" class="link-white rounded" style="color:lightblue;">員工基本資料</a></li>'
                :
                '<li><a href="employee.php" class="link-white rounded"">員工基本資料</a></li>'
              ).
              '
              '
              .(
                ($select=='person') ?
                '<li><a href="person.php" class="link-white rounded" style="color:lightblue;">員工個人資料</a></li>'
                :
                '<li><a href="person.php" class="link-white rounded">員工個人資料</a></li>'
              ).
              '
              '
              .(
                ($select=='exp') ?
                '<li><a href="exp.php" class="link-white rounded" style="color:lightblue;">員工工作經驗</a></li>'
                :
                '<li><a href="exp.php" class="link-white rounded">員工工作經驗</a></li>'
              ).
              '
              '
              .(
                ($select=='overtime') ?
                '<li><a href="overtime.php" class="link-white rounded" style="color:lightblue;">加班資料</a></li>'
                :
                '<li><a href="overtime.php" class="link-white rounded">加班資料</a></li>'
              ).
              '
              '
              .(
                ($select=='leav') ?
                '<li><a href="leav.php" class="link-white rounded" style="color:lightblue;">請假資料</a></li>'
                :
                '<li><a href="leav.php" class="link-white rounded">請假資料</a></li>'
              ).
              '
              '
              .(
                ($select=='dept') ?
                '<li><a href="dept.php" class="link-white rounded" style="color:lightblue;">部門資料</a></li>'
                :
                '<li><a href="dept.php" class="link-white rounded">部門資料</a></li>'
              ).
              '
              '
              .(
                ($select=='quota') ?
                '<li><a href="quota.php" class="link-white rounded" style="color:lightblue;">業績目標</a></li>'
                :
                '<li><a href="quota.php" class="link-white rounded">業績目標</a></li>'
              ).
              '
            </ul>
          </div>
        ...
        <li class="mb-1">
          <button style="color:red;" class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#outside-collapse" aria-expanded="false">
            外部人員管理
          </button>
          '
          .(
            ($select=='customer' or $select=='supplier') ?
            '<div class="collapse show" id="outside-collapse">'
            :
            '<div class="collapse" id="outside-collapse">'
          ).
          '
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
              '
              .(
                ($select=='customer') ?
                '<li><a href="customer.php" class="link-white rounded" style="color:lightblue;">顧客資料</a></li>'
                :
                '<li><a href="customer.php" class="link-white rounded">顧客資料</a></li>'
              ).
              '
              '
              .(
                ($select=='supplier') ?
                '<li><a href="supplier.php" class="link-white rounded" style="color:lightblue;">供應商資料</a></li>'
                :
                '<li><a href="supplier.php" class="link-white rounded">供應商資料</a></li>'
              ).
              '
            </ul>
          </div>
        ...
        <li class="mb-1">
          <button style="color:red;" class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#order-collapse" aria-expanded="false">
            訂單管理
          </button>
          '
          .(
            ($select=='salesorder' or $select=='orderdetail') ?
          ...
          '
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
              ...
              .(
                ($select=='salesorder') ?
                '<li><a href="salesorder.php" class="link-white rounded" style="color:lightblue;">銷售訂單</a></li>'
                :
                '<li><a href="salesorder.php" class="link-white rounded">銷售訂單</a></li>'
              ).
              '
              '
              .(
                ($select=='orderdetail') ?
                '<li><a href="orderdetail.php" class="link-white rounded" style="color:lightblue;">訂單明細</a></li>'
                :
                '<li><a href="orderdetail.php" class="link-white rounded">訂單明細</a></li>'
              ).
              '
            </ul>
          </div>
        ...
        <li class="mb-1">
          <button style="color:red;" class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#product-collapse" aria-expanded="false">
            產品管理
          </button>
          '
          .(
            ($select=='product' or $select=='inv' or $select=='purchaseorder' or $select=='purchasedetail') ?
          ...
          '
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
              ...
              .(
                ($select=='product') ?
                '<li><a href="product.php" class="link-white rounded" style="color:lightblue;">產品資料</a></li>'
                :
                '<li><a href="product.php" class="link-white rounded">產品資料</a></li>'
              ).
              '
              '
              .(
                ($select=='inv') ?
                '<li><a href="inv.php" class="link-white rounded" style="color:lightblue;">產品存量</a></li>'
                :
                '<li><a href="inv.php" class="link-white rounded">產品存量</a></li>'
              ).
              '
              '
              .(
                ($select=='purchaseorder') ?
                '<li><a href="purchaseorder.php" class="link-white rounded" style="color:lightblue;">產品訂購單</a></li>'
                :
                '<li><a href="purchaseorder.php" class="link-white rounded">產品訂購單</a></li>'
              ).
              '
              '
              .(
                ($select=='purchasedetail') ?
                '<li><a href="purchasedetail.php" class="link-white rounded" style="color:lightblue;">產品訂購明細</a></li>'
                :
                '<li><a href="purchasedetail.php" class="link-white rounded">產品訂購明細</a></li>'
              ).
              '
            </ul>
          </div>
